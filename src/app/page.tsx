...
const services = [
  ...
  {
    img: "/Pictures/dsc03284-enhanced-nr-1098536469.jpg",
    price: "da €20 / lezione",
    title: "Danza & Beauty",
    sub: "Danza Classica · Choreo Dance · Centro Estetico",
    desc: "Tecnica, eleganza e cura del corpo. Lezioni di danza classica e choreo, più trattamenti beauty per il tuo benessere totale.",
  },
];
...
const team = [
  {
    ...
    bio: "Ex nuotatrice agonista, ha trasformato la sua esperienza atletica in un approccio unico. Ha portato il California Barre a Sanremo ed è attualmente laureanda in Scienze Motorie.",
    cert: "Certificata Pilates Reformer · California Barre · Nuoto",
    img: "/Pictures/dsc03293-enhanced-nr-1887829781.jpg",
  },
  {
    name: "Alice Farina",
  ...
  },
  {
    ...
    img: "/Pictures/dsc03299-enhanced-nr-1762911297.jpg",
  },
];
    ...
    <main className="bg-[#F8F4EF] text-[#1A1714]">
          ...
          {[
            {
              ...
              desc: "Macchine professionali di nuova generazione. Tre livelli per ogni obiettivo fisico.",
            },
            {
              label: "California Barre",
              desc: "Il metodo di Sophia Jeremiasz: la fusione perfetta di Pilates, yoga e fitness alla sbarra.",
            },
            {
              label: "Beauty Center",
              desc: "Trattamenti estetici e di benessere per prenderti cura di tutto te stesso.",
            },
          ].map((p) => (
      ...
      <section className="py-24 lg:py-36 px-6 bg-[#F8F4EF]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28 items-center">
          <div className="order-2 lg:order-1">
            <p className="text-[#B8A898] tracking-[0.32em] uppercase text-[11px] mb-6">
              Il Nostro Studio
            </p>
            <h2 className="serif text-[clamp(2.2rem,4vw,3.4rem)] font-light leading-[1.15] mb-8">
              Un nuovo concetto<br />di benessere<br />
              <em>nel cuore di Sanremo</em>
            </h2>
              ...
              {[
                ...
                <div key={s.label} className="flex items-center gap-10">
                  <div className="text-center">
                    ...
                    <p className="text-[#B8A898] text-[10px] tracking-[0.28em] uppercase mt-1.5">
                      {s.label}
                    </p>
                  </div>
                  {i < arr.length - 1 && (
                    <div className="w-px h-12 bg-[#E8DDD5]" />
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="order-1 lg:order-2 relative aspect-[3/4] overflow-hidden">
            <Image
              src="/Pictures/dsc03290-enhanced-nr-275398005.jpg"
              alt="Studio Pharma interno"
              fill
              className="object-cover"
      ...
      <section id="servizi" className="py-24 px-6 bg-[#EFE8DE]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#B8A898] tracking-[0.32em] uppercase text-[11px] mb-4">
              Cosa offriamo
            </p>
            <h2 className="serif text-[clamp(2rem,4vw,3rem)] font-light">
              I Nostri Servizi
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {services.map((s) => (
              <div key={s.title} className="group relative overflow-hidden aspect-[4/3] cursor-pointer">
                <Image
                  src={s.img}
                  alt={s.title}
                  fill
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end">
                  <p className="text-[#C9A96E] text-[10px] tracking-[0.32em] uppercase mb-2">
                    {s.price}
                  </p>
                  <h3 className="serif text-white text-[1.75rem] font-light leading-tight mb-1.5">
                    {s.title}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-14">
            {team.map((t) => (
              <div key={t.name} className="group">
                ...
                <p className="text-[#C9A96E] text-[10px] tracking-[0.26em] uppercase mb-3">
                  {t.role}
                </p>
                <p className="text-[#5C5046] text-[13px] leading-relaxed mb-4">{t.bio}</p>
                <p className="text-[#B8A898] text-[10px] tracking-wide">{t.cert}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="relative h-64 md:h-80 lg:h-96">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-[#1A1714]/52 flex items-center justify-center px-6">
      ...
      <section id="prezzi" className="bg-[#1A1714] text-white py-24 lg:py-36 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#C9A96E] tracking-[0.32em] uppercase text-[11px] mb-4">
              Abbonamenti
            </p>
          ...
          <div className="border border-[#C9A96E]/40 p-10 text-center max-w-md mx-auto mb-16 hover:border-[#C9A96E]/70 transition-colors duration-300">
            <p className="text-[#C9A96E] text-[10px] tracking-[0.32em] uppercase mb-3">
              Inizia da qui
            </p>
            ...
            <p className="text-white/30 text-[10px] tracking-widest uppercase mb-7">
              Validità 1 mese
            </p>
            <a
              href="https://app.shaggyowl.com/accesso-cliente/index.html"
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left py-4 pr-6 text-[10px] tracking-[0.28em] uppercase text-white/30 font-normal">
                    Disciplina
                  </th>
                  {["1 lez.", "5 lez.", "10 lez.", "20 lez."].map((h, i) => (
                    <th
                      key={h}
                      className={`py-4 px-3 text-[10px] tracking-[0.22em] uppercase text-white/30 font-normal ${
                        i === 3 ? "text-right pl-3" : "text-right"
                      }`}
                    >
                      {h}
                      {i > 0 && (
                ...
                {pricing.map((r) => (
                  ...
                  >
                    <td className="py-5 pr-6">
                      <span className="serif text-[1.15rem] font-light">{r.name}</span>
                    </td>
          ...
          <div className="mt-14 pt-14 border-t border-white/10">
            <p className="text-white/28 text-[10px] tracking-[0.32em] uppercase text-center mb-8">
              Pacchetti Combo
            </p>
      ...
      <section id="contatti" className="py-24 lg:py-36 px-6 bg-[#F8F4EF]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28 items-start">
          <div>
            ...
            <h2 className="serif text-[clamp(2rem,4vw,3rem)] font-light mb-12">
              Vieni a trovarci
            </h2>

            <div className="space-y-8">
              <div>
                <p className="text-[#B8A898] text-[10px] tracking-[0.28em] uppercase mb-2">
                  Indirizzo
                </p>
                <p className="serif text-xl font-light">Via Escoffier 3</p>
                <p className="serif text-xl font-light">18038 Sanremo (IM)</p>
                <p className="text-[#5C5046] text-[12px] mt-1.5">
                  Nel centro città, vicino al Teatro Ariston
                </p>
              </div>
              ...
              <div>
                ...
                <a
                  href="tel:+390184631575"
                  className="serif text-xl font-light hover:text-[#C9A96E] transition-colors"
                >
                  0184 631575
                </a>
              </div>
              ...
              <div>
                ...
                <a
                  href="mailto:info@studio-pharma.com"
                  className="serif text-xl font-light hover:text-[#C9A96E] transition-colors"
                >
              ...
              <div>
                <p className="text-[#B8A898] text-[10px] tracking-[0.28em] uppercase mb-3">
                  Seguici
                </p>
                <div className="flex gap-7">
                  <a
                    href="https://www.instagram.com/studiopharma_sanremo/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=61587581562464"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[11px] tracking-[0.22em] uppercase border-b border-[#1A1714]/30 pb-0.5 hover:border-[#C9A96E] hover:text-[#C9A96E] transition-all"
                  >
              ...
              <div>
                ...
                <div className="flex gap-7">
                  <a
                    href="https://apps.apple.com/it/app/studiopharma/id6759036038"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[11px] tracking-[0.22em] uppercase border-b border-[#1A1714]/30 pb-0.5 hover:border-[#C9A96E] hover:text-[#C9A96E] transition-all"
                  >
                  ...
                  <a
                    href="https://play.google.com/store/apps/details?id=com.shaggyowl.pharma"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[11px] tracking-[0.22em] uppercase border-b border-[#1A1714]/30 pb-0.5 hover:border-[#C9A96E] hover:text-[#C9A96E] transition-all"
                  >
          ...
          <div className="relative aspect-[4/5] overflow-hidden">
            <Image
              src="/Pictures/dsc03314-enhanced-nr-2009911129.jpg"
              alt="Studio Pharma"
              fill
              className="object-cover"
              sizes="(max-width: 1024px) 100vw, 50vw"
      ...
      <footer className="bg-[#1A1714] py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6 text-[10px] tracking-[0.22em] uppercase text-white/25">
            <a
              href="https://studio-pharma.com/cookies.html"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://app.shaggyowl.com/amministrazione/privacy-app.html"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white/55 transition-colors"
            >
